...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WikiPageMeta'
        db.create_table('wikinya_wikipagemeta', (
        ...
        db.send_create_signal('wikinya', ['WikiPageMeta'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'WikiPageMeta'
        db.delete_table('wikinya_wikipagemeta')
