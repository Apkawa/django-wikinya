...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WikiImage.author'
        db.add_column('wikinya_wikiimage', 'author', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WikiImage.author'
        db.delete_column('wikinya_wikiimage', 'author_id')
