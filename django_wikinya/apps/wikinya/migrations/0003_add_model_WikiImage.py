...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WikiImage'
        db.create_table('wikinya_wikiimage', (
            ...
            ('image', self.gf('utils.snippets.thumbsimagefield.ThumbsImageField')(max_length=100)),
            ('meta_info', self.gf('utils.snippets.picklefield.PickledObjectField')(null=True, blank=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='images', null=True, to=orm['wikinya.WikiPage'])),
        ))
        db.send_create_signal('wikinya', ['WikiImage'])


    def backwards(self, orm):
        
        # Deleting model 'WikiImage'
        db.delete_table('wikinya_wikiimage')
